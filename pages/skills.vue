<template>
    <div class="content">
        ...
        <h1>Talents</h1>
            ...
            <TextCard color="#ffffffbb" title="Coding" content="I first learned programming in Grade 5 through Scratch, 
            ...
            I've involved myself in other self-driven projects including Minecraft mods, web development, and more video games.">
                <ImageCard color="white" image="/images/quest-for-conception.png" caption="The Quest for Conception - Created by Asher Chan and Jayden Law" />
            </TextCard>
            <TextCard color="#ecc7fc" title="Juggling" content="My juggling journey began in the spring of 2022, where I first learned the 3 ball cascade. 
